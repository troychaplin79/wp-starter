...
// 	require_once get_template_directory() . '/functions/wp-plugins/gravityforms/global.php';
// }

// // WordPress SEO specific common functions
// if ( defined( 'WPSEO_VERSION' ) ) {
// 	require_once get_template_directory() . '/functions/wp-plugins/wordpress-seo/global.php';
// }
