...
function wpbase_front_end_enqueues() {
	...
	wp_enqueue_style( 'styles', get_template_directory_uri() . '/dist/css/styles.css&id=' . wp_rand(), false, THEME_VERSION, 'screen' );
	wp_enqueue_script( 'scripts', get_template_directory_uri() . '/dist/js/scripts.js&id=' . wp_rand(), null, THEME_VERSION, true );
}
